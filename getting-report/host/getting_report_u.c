...
oe_result_t enclave_getting_report(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;

    /* Marshalling struct. */
    enclave_getting_report_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_getting_report_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_getting_report_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (enclave_getting_report_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             getting_report_fcn_id_enclave_getting_report,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (enclave_getting_report_args_t*)_output_buffer;
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             getting_report_fcn_id_oe_get_sgx_report_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             getting_report_fcn_id_oe_get_report_v2_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             getting_report_fcn_id_oe_verify_local_report_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             getting_report_fcn_id_oe_sgx_init_context_switchless_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_enclave_worker_context_t* context)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             getting_report_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
static oe_ocall_func_t __getting_report_ocall_function_table[] = {
...
oe_result_t oe_create_getting_report_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               __getting_report_ocall_function_table,
               80,
               enclave);
}
